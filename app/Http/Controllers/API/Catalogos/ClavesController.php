...
class ClavesController extends Controller
{
    ...
    public function Validar(Request $request)
    {
        try{
            ...
            DB::statement("CREATE TEMPORARY TABLE __cpm (id int AUTO_INCREMENT PRIMARY KEY, catalogo_fecha_cpm_id BIGiNT, gpo VARCHAR(20), clave VARCHAR(20), descripcion VARCHAR(250), cpm MEDIUMINT UNSIGNED)");
